...
func (r *RedisCache) SetBlockBuilderStatus(builderPubkey string, status common.BuilderStatus) (err error) {
	return r.client.HSet(context.Background(), r.keyBlockBuilderStatus, builderPubkey, uint8(status)).Err()
}

func (r *RedisCache) GetBlockBuilderStatus(builderPubkey string) (status common.BuilderStatus, err error) {
